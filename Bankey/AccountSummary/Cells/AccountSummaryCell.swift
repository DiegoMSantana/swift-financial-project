...
extension AccountSummaryCell  {
    ...
    private func setup() {
        ...
        underlineView.backgroundColor = appCollor
       ...
       // balanceAmountLabel.text = "R$ 0,00"
        balanceAmountLabel.attributedText = makeFormattedBalance(dollars: "XXX.XXX", cents: "XX")
        balanceAmountLabel.textAlignment = .right
        
        chevronImageView.translatesAutoresizingMaskIntoConstraints = false
        let chevronImage = UIImage(systemName: "chevron.right")!.withTintColor(appCollor, renderingMode: .alwaysOriginal)
    ...
    func configure(with vm: ViewModel) {
        ...
        switch vm.accountType {
                ...
                case .CreditCard:
                    ...
                    balanceLabel.text = "Fatura Atual"
                case .Investment:
